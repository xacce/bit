...
from .samples import (
    ...
    BITCOIN_ADDRESS_TEST_PAY2SH, BITCOIN_HASH_PAY2SH, BITCOIN_HASH_TEST_PAY2SH,
...
def test_address_to_public_key_hash():
    ...
    assert address_to_public_key_hash(BITCOIN_ADDRESS_PAY2SH) == bytes.fromhex(BITCOIN_HASH_PAY2SH)
    assert address_to_public_key_hash(BITCOIN_ADDRESS_TEST_PAY2SH) == bytes.fromhex(BITCOIN_HASH_TEST_PAY2SH)
